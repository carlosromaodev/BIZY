...
export const moduloMarket: ModuloHttp = {
  ...
  registrar(app, contexto) {
    ...
    // Fase 3: CRUD Catálogos da loja no CRM
    app.get("/crm/loja/catalogos", async (request, reply) => {
      aplicarNoStore(reply);
    ...
    app.post("/crm/loja/catalogos", async (request, reply) => {
      aplicarNoStore(reply);
      const ctx = await exigirAcessoComercial(contexto, request, reply, {
        permissao: "loja-publica:gerir",
        modulo: "loja-publica",
    ...
    app.put("/crm/loja/catalogos/:id", async (request, reply) => {
      aplicarNoStore(reply);
      const ctx = await exigirAcessoComercial(contexto, request, reply, {
        permissao: "loja-publica:gerir",
        modulo: "loja-publica",
    ...
    app.delete("/crm/loja/catalogos/:id", async (request, reply) => {
      aplicarNoStore(reply);
      const ctx = await exigirAcessoComercial(contexto, request, reply, {
        permissao: "loja-publica:gerir",
        modulo: "loja-publica",
    ...
    // Fase 3: Seguidores da loja no CRM
    app.get("/crm/loja/seguidores", async (request, reply) => {
      aplicarNoStore(reply);
      const ctx = await exigirAcessoComercial(contexto, request, reply, {
        permissao: "loja-publica:gerir",
        modulo: "loja-publica",
    ...
    // Fase 3: Métricas da loja no CRM
    app.get("/crm/loja/metricas", async (request, reply) => {
      aplicarNoStore(reply);
      const ctx = await exigirAcessoComercial(contexto, request, reply, {
        permissao: "loja-publica:gerir",
        modulo: "loja-publica",
    ...
    // ── Pedidos com origem Market no CRM da loja ──

    app.get("/crm/loja/pedidos-market", async (request, reply) => {
      aplicarNoStore(reply);
      const ctx = await exigirAcessoComercial(contexto, request, reply, {
    ...
    // ── Repasses financeiros no CRM da loja ──

    app.get("/crm/loja/repasses", async (request, reply) => {
      aplicarNoStore(reply);
      const ctx = await exigirAcessoComercial(contexto, request, reply, {
