...
As lacunas de lancamento devem ser lidas em [[prioridades-lancamento-bizy]]. O P0 do roadmap atual esta fechado; a sequencia agora e P1/P2 sem inventar nova visao: projectors duraveis Anani, polimento operacional, matriz de permissoes e melhorias de primeira operacao. Read models iniciais Anani e guard frontend de URL por modulo ja foram fechados.
