...
> [!abstract] Entrada principal
> Este indice e apenas o mapa do vault. A memoria real esta distribuida entre notas conectadas por `[[wikilinks]]`.
...
- [[bizy-estado-atual|Estado Atual do Bizy]]

## Operacao e Infraestrutura

- [[deploy-vps-antiga|Deploy na VPS Antiga]]
- [`docs/deploy.md`](../deploy.md)
- [`docs/DEPLOY_VPS_ANTIGA.md`](../DEPLOY_VPS_ANTIGA.md)
- [`docs/docker.md`](../docker.md)
- [`docs/staging.md`](../staging.md)
- [`docs/observabilidade.md`](../observabilidade.md)
- [`docs/ngrok.md`](../ngrok.md)
- [`docs/n8n.md`](../n8n.md)
- [`docs/integracoes.md`](../integracoes.md)
...
- [`README.md`](../../README.md)
- [`docs/STYLEGUIDE-FRONTEND-EMEU.md`](../STYLEGUIDE-FRONTEND-EMEU.md)
- [`docs/ANALISE-DESIGN-FRONTEND-EMEU.md`](../ANALISE-DESIGN-FRONTEND-EMEU.md)
- [[identidade-visual-bizy-v2|Identidade Visual Bizy v2]]
- [[auditoria-visual-frontend-bizy-v2|Auditoria Visual Frontend Bizy v2]]

## Organizacao do Vault

- [[bizy-memoria.canvas|Canvas da Memoria Bizy]]
- [[obsidian-vault|Vault Obsidian]]
- [[organizacao-de-arquivos|Organizacao de Arquivos]]
...
- [`docs/superpowers/plans/2026-05-23-bizy-design-interno-comercio-suave.md`](../superpowers/plans/2026-05-23-bizy-design-interno-comercio-suave.md)
- [`docs/superpowers/plans/2026-05-24-bizy-home-auth-onboarding.md`](../superpowers/plans/2026-05-24-bizy-home-auth-onboarding.md)
- [`docs/superpowers/specs/2026-05-21-migracao-uorconnect-servicos-design.md`](../superpowers/specs/2026-05-21-migracao-uorconnect-servicos-design.md)
- [`docs/superpowers/specs/2026-05-23-bizy-design-interno-comercio-suave-design.md`](../superpowers/specs/2026-05-23-bizy-design-interno-comercio-suave-design.md)

## n8n e Workflows

- [`n8n/README.md`](../../n8n/README.md)
- [`n8n/workflows/emeu-eventos-vendas.json`](../../n8n/workflows/emeu-eventos-vendas.json)
- [`n8n/workflows/emeu-atendimento-whatsapp.json`](../../n8n/workflows/emeu-atendimento-whatsapp.json)
- [`n8n/workflows/emeu-comprovativo-pagamento.json`](../../n8n/workflows/emeu-comprovativo-pagamento.json)
