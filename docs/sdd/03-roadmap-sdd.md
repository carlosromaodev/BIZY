...
| 11 Inteligencia/Anani | [ ] Ligar insights a tarefas, notificacoes WhatsApp e feedback de utilidade; [x] read models iniciais TeamHealth, MarketSnapshot e SecuritySnapshot; [x] projectors duraveis/event-driven; [ ] audit trail; [x] teste HTTP completo de governanca; [x] console interna inicial no frontend. |
