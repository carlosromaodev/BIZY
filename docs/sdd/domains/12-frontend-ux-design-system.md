...
- P0: verificacao de modulos desativados na UI. Mobile 360px sem scroll horizontal, SEO publico, checkout visual, privacidade/tracking e paginacao ja foram fechados.
