...
export const rotasPublicas: RotaPublica[] = [
  ...
  { caminho: "/conta", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/entrar", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/compras", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/compras/:id", elemento: <PaginaCompraUnificada /> },
  { caminho: "/conta/entregas", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/devolucoes", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/favoritos", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/lojas-seguidas", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/enderecos", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/avaliacoes", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/notificacoes", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/mensagens", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/afiliacao", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/seguranca", elemento: <PaginaPortalComprador /> },
  { caminho: "/conta/privacidade", elemento: <PaginaPortalComprador /> },
  { caminho: "/compras", elemento: <Navigate replace to="/conta/compras" /> },
  { caminho: "/compras/:id", elemento: <PaginaCompraUnificada /> },
  { caminho: "/creator", elemento: <PaginaCreatorPortal /> },
  { caminho: "/creator/onboarding", elemento: <PaginaCreatorPortal /> },
  ...
  { caminho: "/creator/solicitacoes", elemento: <PaginaCreatorPortal /> },
  { caminho: "/creator/parcerias", elemento: <PaginaCreatorPortal /> },
  { caminho: "/creator/perfil", elemento: <PaginaCreatorPortal /> },
  ...
  { caminho: "/p/:listingId/:slugProduto", elemento: <PaginaProdutoMarket /> },
  { caminho: "/produtos/:codigo", elemento: <Navigate replace to="/market" /> },
  { caminho: "/lojas", elemento: <PaginaDiretorioLojasMarket /> },
  { caminho: "/categorias/:categoria", elemento: <PaginaMarket /> },
  { caminho: "/market/p/:listingId/:slugProduto", elemento: <PaginaProdutoMarket /> },
  { caminho: "/market/produtos/:codigo", elemento: <Navigate replace to="/market" /> },
