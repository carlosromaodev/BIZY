...
function obterResumoPdpMarket(produto: ProdutoMarketNormalizado) {
...
export function PaginaProdutoMarket() {
  ...
  const resumoComercial = obterResumoPdpMarket(produto);
  ...
  const desconto = produto.descontoPercentual ? `-${produto.descontoPercentual}% hoje` : produto.disponivel ? "Em stock" : "Indisponível";
        ...
        >
          <div className="market-pdp-supplier-card market-pdp-seller-v2 seller">
            ...
            <div>
              ...
              <div className="loc">{produto.fornecedor.localizacao || "Loja Bizy verificada"} · responde em ~5 min</div>
            </div>
          ...
          <h1>{produto.nome}</h1>
          <div className="market-pdp-rating stars" aria-label={`${resumoComercial.rating} de 5 estrelas com ${resumoComercial.avaliacoes} avaliações`}>
            <span className="st">
              <Star size={13} />
              <Star size={13} />
              <Star size={13} />
            ...
            <span>{resumoComercial.rating} · {resumoComercial.avaliacoes} avaliações · {resumoComercial.vendidos} vendidos</span>
          </div>
          ...
          <div className="market-pdp-delivery-lines dlines">
            <div className="dline"><Truck size={18} /><span>Entrega em <b>24-48h</b> em Luanda · combinada com {produto.nomeFornecedor}</span></div>
            <div className="dline"><Store size={18} /><span>Retirada <b>grátis</b> na loja · {produto.fornecedor.localizacao || "localização a confirmar"}</span></div>
            <div className="dline"><ShieldCheck size={18} /><span>Troca em <b>7 dias</b> · pagamento por transferência ou Multicaixa</span></div>
          </div>
