  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center justify-between gap-3 sm:mb-5">
        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#06100d] text-[#d8ff72] shadow-[0_12px_28px_rgba(6,16,13,0.2)] sm:h-12 sm:w-12">
          {icon}
        </div>
...
export function HowItWorks({ className, id = "onboarding", ...props }: HowItWorksProps) {
  return (
    <section
      id={id}
      className={cn("w-full overflow-hidden border-y border-[#d8ff72]/35 bg-[#FBFDF8] py-8 sm:py-16 lg:py-20", className)}
      {...props}
      style={{ ...props.style, fontFamily: PROMPT_FONT_FAMILY }}
    >
      <div className="mx-auto max-w-7xl px-4">
        <div className="mx-auto mb-6 max-w-4xl text-center sm:mb-12">
          <p className="mx-auto mb-3 w-fit border border-[#c5df75] bg-[#f1ffd0] px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#23491f] sm:mb-4">
            Primeiro acesso
          </p>
          <h2 className="text-2xl font-bold tracking-tight text-[#06100d] sm:text-4xl" style={{ fontFamily: PROMPT_FONT_FAMILY, color: "#06100d" }}>
        ...
        <div className="relative mx-auto mb-5 hidden w-full max-w-4xl md:block md:mb-8">
          <div
            aria-hidden="true"
        ...
        <div className="mx-auto mt-4 flex max-w-4xl flex-col gap-2 border border-[#d9ded8] bg-white px-4 py-3 text-sm text-[#53615a] shadow-[0_18px_60px_rgba(6,16,13,0.05)] sm:mt-10 sm:flex-row sm:items-center sm:justify-between sm:py-4">
