...
export const ROTAS_API_LOJAS = {
  ...
  sellerOnboarding: "/team/loja/seller/onboarding",
  sellerConta: "/team/loja/seller/conta",
  checklistCatalogoMarketTeam: "/team/loja/catalogo/checklist",
  disputasMarketTeam: "/team/loja/disputas",
  decisaoDisputaMarketTeam: (id: string) => `/team/loja/disputas/${segmento(id)}/decisao`,
  casosPosVendaMarketTeam: "/team/loja/pos-venda/casos",
  trustSafetyMarketTeam: "/team/loja/trust-safety/fila",
  reembolsosMarketTeam: "/team/loja/reembolsos",
  eventosMarketTeam: "/team/loja/eventos-market",
